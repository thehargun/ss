...
app.post('/submit-order', (req, res) => {
    ...
    const orderDetails = req.session.cart.map(item => `${item.itemName} - Quantity: ${item.quantity}`).join(', ');

    // Implement nodemailer to send order details
    // See previous instructions on setting up nodemailer

    sendOrderEmail(orderDetails); // Assuming you've set up this function
